...
workflow HLATYPING {
    ...
    ch_multiqc_files = ch_multiqc_files.mix(OPTITYPE.out.hla_type.collect{it[1]}.ifEmpty([]))
    ch_multiqc_files = ch_multiqc_files.mix(OPTITYPE.out.coverage_plot.collect{it[1]}.ifEmpty([]))
